...
2. **Real-time Order Alerts (Websockets):**
   - Connect to the `ws://localhost:5000` socket server.
...
```bash
curl -X POST http://localhost:5000/api/auth/signup/restaurant-owner \
...
```bash
curl -X POST http://localhost:5000/api/owner/restaurant \
...
```bash
curl -X PUT http://localhost:5000/api/owner/restaurant/<restaurantId> \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
-d '{"deliveryTime":35}'
```
...
```bash
curl -X PUT http://localhost:5000/api/owner/restaurant/<restaurantId>/toggle-active \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
-d '{"status":"Open"}'
```
...
**Add Menu Item**
```bash
curl -X POST http://localhost:5000/api/owner/restaurant/<restaurantId>/menu \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
...
**Get Menu Items**
```bash
curl -X GET http://localhost:5000/api/owner/restaurant/<restaurantId>/menu \
-H "Authorization: Bearer <TOKEN>"
```

**Update Menu Item**
```bash
curl -X PUT http://localhost:5000/api/owner/restaurant/<restaurantId>/menu/<itemId> \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
-d '{"price": 160}'
```
...
```bash
curl -X DELETE http://localhost:5000/api/owner/restaurant/<restaurantId>/menu/<itemId> \
-H "Authorization: Bearer <TOKEN>"
```

**Toggle Item Availability (Out of stock)**
```bash
curl -X PUT http://localhost:5000/api/owner/restaurant/<restaurantId>/menu/<itemId>/toggle-availability \
-H "Authorization: Bearer <TOKEN>"
```
...
```bash
curl -X GET http://localhost:5000/api/owner/restaurant/<restaurantId>/orders \
-H "Authorization: Bearer <TOKEN>"
```

**Accept Order**
```bash
curl -X PUT http://localhost:5000/api/owner/restaurant/<restaurantId>/orders/<orderId>/accept \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
...
```bash
curl -X PUT http://localhost:5000/api/owner/restaurant/<restaurantId>/orders/<orderId>/reject \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
...
**Mark as Preparing**
```bash
curl -X PUT http://localhost:5000/api/owner/restaurant/<restaurantId>/orders/<orderId>/preparing \
-H "Authorization: Bearer <TOKEN>"
```

**Mark as Ready for Pickup (Releases job to Delivery Partners)**
```bash
curl -X PUT http://localhost:5000/api/owner/restaurant/<restaurantId>/orders/<orderId>/ready \
-H "Authorization: Bearer <TOKEN>"
```
...
**Get Dashboard Stats**
```bash
curl -X GET http://localhost:5000/api/owner/restaurant/<restaurantId>/dashboard \
-H "Authorization: Bearer <TOKEN>"
```
...
```bash
curl -X POST http://localhost:5000/api/owner/<restaurantId>/coupons \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
...
**Get Vendor Coupons**
```bash
curl -X GET http://localhost:5000/api/owner/<restaurantId>/coupons \
-H "Authorization: Bearer <TOKEN>"
```

**Update Vendor Coupon**
```bash
curl -X PUT http://localhost:5000/api/owner/<restaurantId>/coupons/<couponId> \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
-d '{"isActive":false}'
```
...
```bash
curl -X DELETE http://localhost:5000/api/owner/<restaurantId>/coupons/<couponId> \
-H "Authorization: Bearer <TOKEN>"
```
...
```bash
curl -X GET http://localhost:5000/api/owner/<restaurantId>/settlements \
-H "Authorization: Bearer <TOKEN>"
```

```bash
curl -X POST http://localhost:5000/api/owner/<restaurantId>/settlements/generate \
-H "Authorization: Bearer <TOKEN>"
```
...
```bash
curl -X PUT http://localhost:5000/api/owner/<restaurantId> \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
...
```bash
curl -X PUT http://localhost:5000/api/owner/<restaurantId>/menu/<menuItemId> \
-H "Authorization: Bearer <TOKEN>" -H "Content-Type: application/json" \
